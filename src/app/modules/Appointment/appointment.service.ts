...
const createAppointmentService = async (
  ...
  if (!doctorScheduleExist) {
    throw new ApiError(
      404,
      "DoctorSchedule does not exist by the combination of this scheduleId & doctorId"
    );
  }
...
const changePaymentStatusService = async (
  appointmentId: string,
